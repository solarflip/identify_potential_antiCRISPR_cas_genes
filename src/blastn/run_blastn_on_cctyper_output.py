...
def run_blastn_on_cctyper_output(cctyper_output_paths : str, output_dir : str):
    """
    for one genome
    """
    ...
    run_blastn_spacer_folder(spacer_path,output_path)
...
if __name__ == "__main__":
    ...
    run_blastn_on_cctyper_output(args.input, args.output)